...
class Drawable {
    ...
    updateTileOffset(x, y){
        if (this._tileX !== x || this._tileY !== y) {
            this._tileX = x;
            this._tileY = y;
            this._tileOffsetDirty = true;
            this._transformDirty = true;
        }
    }
    ...
    _calculateTransform () {
        ...
        if(this._tileOffsetDirty && this.skin !== null){
            const skinSize = this.skin.size;
            this._tileOffset[0] = - this._tileX / skinSize[0];
            this._tileOffset[1] = this._tileY / skinSize[1];
            this._uniforms.u_tileOffset = this._tileOffset;
            this._tileOffsetDirty = false;
        }
    ...
    get rotationCenter () {
        if(this._skin){
            return this._skin.rotationCenter;
        }
        return [0, 0, 0];
    }

...
class RenderWebGL extends EventEmitter {
    ...
    updateDrawableSkinId (drawableID, skinId) {
        ...
        //         return;
        //     }
        //     const delSkin = drawable.skin;
        //     setTimeout(()=>{
        //         if(drawable.skin !== delSkin) delSkin.deleteTexture();
        //     });
    ...
    _drawThese (drawables, drawMode, projection, opts = {}) {
        ...
        for (let drawableIndex = 0; drawableIndex < numDrawables; ++drawableIndex) {
            ...
            if(drawable.skin.id === window.__bugskinId){
                console.log( "draw, xxxx", uniforms.u_skin)
                window.__bugskinId = null;
            }
            if (uniforms.u_skin) {

...
class Silhouette {
     ...
     */
    update (bitmapData, isPremultiplied = false, w, h) {
        if(bitmapData instanceof Uint8Array){
            this._colorData = bitmapData;
            this._width = w;
            this._height = h;
        }else if (bitmapData instanceof ImageData) {
            // If handed ImageData directly, use it directly.
            this._width = bitmapData.width;
            this._height = bitmapData.height;
            this._colorData = bitmapData.data;
        } else {

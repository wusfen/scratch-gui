...
class BitmapSkin extends Skin {
    ...
    getTexture (scale) {
        if (this._texture === null && this._textureData) {

            if(this.id === window.__bugskinId) console.log("getTexture", window.__bugskinId);
    ...
    setBitmap (bitmapData, costumeResolution, rotationCenter) {
        ...
        if(this.id === window.__bugskinId) console.log("setBitmap have", window.__bugskinId);
        if (this._texture) {
            this._renderer.gl.deleteTexture(this._texture);
            if(this.id === window.__bugskinId) console.log("setBitmap have", window.__bugskinId);
        }

...
class JSONRPC {
    ...
    sendRemoteRequest (method, params) {
        ...
        if(Object.keys(this._openRequests).length > 1){
            this._optQueque.push({method, params, requestID});
        }else{
    ...
    _handleResponse (json) {
        ...
        if(this._optQueque.length > 0){
            const data = this._optQueque.shift();
            this._sendRequest(data.method, data.params, data.requestID);
        }
    }

...
class Scratch3MotionBlocks {
    ...
    moveSteps (args, util) {
        ...
        if(util.target.isStage){
            util.target.setTileOffset(util.target.tileX + dx, util.target.tileY + dy);
            return;
        }
    ...
    glide (args, util) {
        if (util.stackFrame.timer) {
            ...
            if (timeElapsed < util.stackFrame.duration * 1000) {
                ...
                if(util.target.isStage){
                    util.target.setTileOffset(util.stackFrame.endX, util.stackFrame.endY);
                }
            ...
            if(util.target.isStage){
                util.stackFrame.startX = util.target.tileX;
                util.stackFrame.startY = util.target.tileY;
            }else{
    ...
    changeX (args, util) {
        ...
        if(util.target.isStage){
            util.target.setTileOffset(util.target.tileX + dx, util.target.tileY);
            return;
        }
    ...
    setX (args, util) {
        const x = Cast.toNumber(args.X);
        if(util.target.isStage){
            util.target.setTileOffset(x, util.target.tileY);
            return;
        }
    ...
    changeY (args, util) {
        ...
        if(util.target.isStage){
            util.target.setTileOffset(util.target.tileX, util.target.tileY + dy);
            return;
        }
    ...
    setY (args, util) {
        const y = Cast.toNumber(args.Y);
        if(util.target.isStage){
            util.target.setTileOffset(util.target.tileX,  y);
            return;
        }

...
class Mouse {
    ...
    postData (data) {
        ...
        var stageCssScale = window.STAGE_WIDTH / window.store.getState().scratchGui.stageSize.stageCssWidth;
        this._scratchX = this._scratchX * stageCssScale;
        this._scratchY = this._scratchY * stageCssScale;

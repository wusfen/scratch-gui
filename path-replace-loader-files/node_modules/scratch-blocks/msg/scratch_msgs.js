...
Blockly.ScratchMsgs.locales.en =
{
    ...
    "EVENT_WHENFLAGCLICKED": "when start clicked%1",
    ...
    "DUPLICATE_AND_PASTE": "Duplicate and paste",
    "COPY": "Duplicate",
    "PASTE": "Paste",
    "DELETE": "Delete",
...
Blockly.ScratchMsgs.locales["zh-cn"] =
{
    ...
    "EVENT_WHENFLAGCLICKED": "当 开始 被点击%1",
    ...
    "MOTION_STAGE_SELECTED": "选中了背景：不可使用运动类积木",
    "OPERATORS_ADD": "%1 + %2",
    "OPERATORS_SUBTRACT": "%1 - %2",
    "OPERATORS_MULTIPLY": "%1 * %2",
    "OPERATORS_DIVIDE": "%1 / %2",
    ...
    "CATEGORY_MYBLOCKS": "自制",
    "DUPLICATE_AND_PASTE": "复制并粘贴",
    "COPY": "复制",
    "PASTE": "粘贴",
    "DELETE": "删除",
    "ADD_COMMENT": "添加注释",
...
Blockly.ScratchMsgs.locales["zh-tw"] =
{
    ...
    "EVENT_WHENFLAGCLICKED": "當 開始 被點擊%1",
    ...
    "MOTION_XSCROLL": "x 捲軸",
    "MOTION_YSCROLL": "y 捲軸",
    "MOTION_STAGE_SELECTED": "目前選擇的物件是「背景」：無可用的動作積木",
    "OPERATORS_ADD": "%1 + %2",
    "OPERATORS_SUBTRACT": "%1 - %2",
    "OPERATORS_MULTIPLY": "%1 * %2",
    "OPERATORS_DIVIDE": "%1 / %2",

...
import {clearRaster, convertBackgroundGuideLayer, getRaster, setupLayers, reSetupBackgroundGuideLayer} from '../helper/layer';
...
class PaperCanvas extends React.Component {
    ...
    componentWillReceiveProps (newProps) {
        ...
        if(this.props.stageMode !== newProps.stageMode){
            reSetupBackgroundGuideLayer(this.props.format);
        }
    }

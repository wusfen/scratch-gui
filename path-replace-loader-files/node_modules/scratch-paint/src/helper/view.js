...
// TODO WSF
const SVG_ART_BOARD_WIDTH = window.MAX_STAGE_WIDTH || 1186;
const SVG_ART_BOARD_HEIGHT = window.MAX_STAGE_HEIGHT * 1.5 || 667 * 1.5;
...
const PADDING_PERCENT = 250; // Padding as a percent of the max of width/height of the sprite
const BUFFER = 50; // Number of pixels of allowance around objects at the edges of the workspace
const MIN_RATIO = .1; // Zoom in to at least 1/10 of the screen. This way you don't end up incredibly

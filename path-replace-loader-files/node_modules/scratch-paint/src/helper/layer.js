...
const _makeBackgroundGuideLayer = function (format) {
    ...
    const vBackground = _makeBackgroundPaper(
        window.STAGE_WIDTH * 2 / CHECKERBOARD_SIZE,
        (window.STAGE_HEIGHT * 2 / CHECKERBOARD_SIZE) + 1,
        '#D9E3F2', 0.55);
    ...
    const bitmapBackground = _makeBackgroundPaper(
        window.STAGE_WIDTH * 2 / CHECKERBOARD_SIZE,
        window.STAGE_HEIGHT * 2 / CHECKERBOARD_SIZE,
        '#D9E3F2', 0.55);
...
const reSetupBackgroundGuideLayer = function (format) {
    let backgroundGuideLayer = getBackgroundGuideLayer();
    backgroundGuideLayer.remove();
    backgroundGuideLayer = _makeBackgroundGuideLayer(format);
    backgroundGuideLayer.sendToBack();
}

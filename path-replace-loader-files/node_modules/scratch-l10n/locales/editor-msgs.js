...
export default {
  'en': {
    ...
    'gui.costumeTab.fileUpload': 'Upload',
    ...
    'gui.libraryTags.property': 'Property',
    'gui.libraryTags.boundary': 'Boundary',
    'gui.libraryTags.natural': 'Natural',
    'gui.libraryTags.life': 'Life',
  ...
  'zh-cn': {
    'gui.alerts.lostPeripheralConnection': '图形化编辑器与{extensionName}的连接已断开。',
    ...
    // eslint-disable-next-line max-len
    'gui.unsupportedBrowser.notRecommended': '我们十分抱歉，图形化编辑器不支持您正在使用的浏览器，我们建议您升级到我们所支持的浏览器的最新版本，例如Chrome、火狐、Edge或者Safari。',
    'gui.unsupportedBrowser.description': '我们十分抱歉，图形化编辑器并不支持您当前使用的浏览器，我们建议您升级到我们所支持的浏览器的最新版，例如Chrome、火狐、Edge或者Safari。',
    ...
    'gui.connection.unavailable.installscratchlink': '确保图形化编辑器 Link已安装并正在运行',
    ...
    'gui.crashMessage.description': '很抱歉，图形化编辑器出故障了。这个问题已经自动报告给图形化编辑器开发团队。请刷新页面再试试。',
    ...
    'gui.menuBar.joinScratch': '加入 图形化编辑器',
    ...
    'gui.telemetryOptIn.label': '统计使用情况并发送给图形化编辑器',
    'gui.telemetryOptIn.body1': '允许图形化编辑器自动发送使用情况信息给图形化编辑器团队，帮助我们了解图形化编辑器在全世界的使用情况。',
    ...
    'gui.telemetryOptIn.buttonTextYes': '好的，我愿意帮助改进图形化编辑器',
    'gui.telemetryOptIn.buttonTooltipYes': '发送统计信息',
    'gui.turboMode.active': '加速模式',
    'gui.webglModal.label': '你的浏览器不支持WebGL',
    // eslint-disable-next-line max-len
    'gui.webglModal.solution': '1.关闭其他正在运行的程序后重试 \n 2.重启本应用 \n 3.如果以上方法均不行，请联系班主任寻求技术支持',
    'gui.webglModal.description': '您的设备当前{webGlLink}。您可以尝试以下方式修复：',
    ...
    'gui.libraryTags.property': '道具',
    'gui.libraryTags.boundary': '界面',
    'gui.libraryTags.natural': '自然',
    'gui.libraryTags.life': '生活',
    ...
    'gui.gui.defaultProjectTitle': '图形化编辑器作品',
    ...
    // "gui.extension.robotmaster.name": "RobotMaster（机器人大师）",
    // "gui.extension.robotmaster.collaborator": "途道机器人",
    // "gui.extension.robotmaster.description": "做你想做的机器人",
    // "gui.extension.robotmaster.connectingMessage": "正在连接",
    "robotmaster.extensionName": "机器人大师",
    "robotmaster.getDistance": "距离传感器1",
    "robotmaster.getDistance2": "距离传感器2",
    "robotmaster.getGyroXaxisAngle": "陀螺仪X轴角度",
    "robotmaster.getGyroYaxisAngle": "陀螺仪y轴角度",
    "robotmaster.getGyroSumAcceleration": "陀螺仪加速度矢量和",
    "robotmaster.setLightHue": "将[LIGHT]的颜色设为[HUE]",
    "robotmaster.turnOffLight": "关掉[LIGHT]",
    "robotmaster.setMotorSpeed": "设置[PORT]以速度[SPEED]按[DIRECTION]转动",
    "robotmaster.setMotorSpeedByNum": "设置[PORT]以速度[SPEED]按[DIRECTION]转动",
    "robotmaster.stopMotor": "停止[PORT]",
    "robotmaster.whenDistance": "当距离传感器[DEV]的值 [OP][REFERENCE]",
    "robotmaster.LedLight.all": "全部灯",
    "robotmaster.LedLight.light1": "灯1",
    "robotmaster.LedLight.light2": "灯2",
    "robotmaster.LedHue.closed": "关闭",
    "robotmaster.LedHue.red": "红",
    "robotmaster.LedHue.orange": "橙",
    "robotmaster.LedHue.yellow": "黄",
    "robotmaster.LedHue.green": "绿",
    "robotmaster.LedHue.cyan": "青",
    "robotmaster.LedHue.blue": "蓝",
    "robotmaster.LedHue.purple": "紫",
    "robotmaster.MotorPort.all": "全部电机",
    "robotmaster.MotorPort.port1": "电机1",
    "robotmaster.MotorPort.port2": "电机2",
    "robotmaster.MotorPort.port3": "电机3",
    "robotmaster.MotorDirection.clockwise": "顺时针",
    "robotmaster.MotorDirection.anticlockwise": "逆时针",
    "robotmaster.tiltDirectionMenu.any": "任意",
    "robotmaster.tiltDirectionMenu.back": "后",
    "robotmaster.tiltDirectionMenu.front": "前",
    "robotmaster.tiltDirectionMenu.left": "左",
    "robotmaster.tiltDirectionMenu.right": "右",
    "robotmaster.whenTilted": "当向[DIRECTION]倾斜",
    "robotmaster.isTilted": "向[DIRECTION]倾斜？",
  },
  'zh-tw': {
    'gui.alerts.lostPeripheralConnection': '圖形化編輯器 與 {extensionName} 的連線中斷。',
    ...
    // eslint-disable-next-line max-len
    'gui.unsupportedBrowser.notRecommended': '很抱歉，這個版本的瀏覽器無法支援 圖形化編輯器。建議你改用其它的，像是 Google Chrome、Mozilla Firefox、Microsoft Edge、Apple Safari。',
    // eslint-disable-next-line max-len
    'gui.unsupportedBrowser.description': '很抱歉，這個瀏覽器無法支援 圖形化編輯器。建議你改用其它的，像是 Google Chrome、Mozilla Firefox、Microsoft Edge、Apple Safari。',
    'gui.unsupportedBrowser.back': '返回',
    ...
    'gui.connection.unavailable.installscratchlink': '確定你已經安裝並執行 圖形化編輯器 Link',
    ...
    'gui.crashMessage.description': '很抱歉，看起來 圖形化編輯器 崩潰了，錯誤已自動回報給 圖形化編輯器 團隊，請重新整理你的頁面，再試一次吧！',
    ...
    'gui.menuBar.joinScratch': '加入 圖形化編輯器',
    ...
    'gui.stageSelector.stage': '舞台',
    'gui.stageSelector.backdrops': '背景',
    'gui.telemetryOptIn.label': '回報統計數據以協助改善 圖形化編輯器',
    // eslint-disable-next-line max-len
    'gui.telemetryOptIn.body1': '圖形化編輯器 團隊希望能深入瞭解 圖形化編輯器 在世界各地的使用情況。如果可以的話，希望你能允許 圖形化編輯器 將你的使用情形紀錄下來並發送給 圖形化編輯器 團隊。',
    // eslint-disable-next-line max-len
    ...
    'gui.telemetryOptIn.buttonTextYes': '是的，我願意幫助，讓 圖形化編輯器 變得更好。',
    'gui.telemetryOptIn.buttonTooltipYes': '啟用 Telemetry',
    'gui.turboMode.active': '加速模式',
    'gui.webglModal.label': '你的瀏覽器不支援 WebGL',
    'gui.webglModal.description': '似乎你的瀏覽器或裝置 {webGlLink}，這是讓 圖形化編輯器 3.0 運作的必要技術。',
    ...
    'gui.gui.defaultProjectTitle': '圖形化編輯器 專案',
